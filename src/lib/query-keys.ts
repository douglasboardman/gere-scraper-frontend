export const qk = {
  atas: {
    ...
    filtered: (params: { identContratacao: string }) =>
      ["atas", params] as const,
  ...
  contratos: {
    ...
    dashboard: (params: Record<string, unknown>) =>
      ["contratos-dashboard", params] as const,
  ...
  fornecimentos: {
    ...
    byContratacao: (id: string, uasg: string) =>
      ["fornecimentos", "contratacao", id, uasg] as const,
    byContrato: (id: string) => ["fornecimentos", "contrato", id] as const,
    byItem: (id: string) => ["fornecimentos", { identItem: id }] as const,
    byParams: (idItem: string, idFornecedor: string, status: string) =>
      ["fornecimentos", idItem, idFornecedor, status] as const,
    wizard: (id: string, uasg: string, identContratoOob?: string) =>
      ["fornecimentos-wizard", id, uasg, identContratoOob] as const,
    addItems: (contratacaoId: string | null, uasg: string) =>
      ["add-items-fornecimentos", contratacaoId, uasg] as const,
    analise: (contratacaoId: string | null, uasg: string) =>
  ...
  itens: {
    ...
    byAta: (identAta: string, identContratacao: string) =>
      ["itens", identAta, identContratacao] as const,
    ...
    analise: (contratacaoId: string | null) =>
      ["analise-itens", contratacaoId] as const,
  },
  ...
  requisicoes: {
    ...
    itens: (identificador: string) =>
      ["itens-requisicao", identificador] as const,
    unidade: (contratacaoId?: string) =>
      ["requisicoes-unidade", contratacaoId] as const,
    ...
    itensAnalise: (identificador: string) =>
      ["itens-analise", identificador] as const,
  },
  ...
  configContratacao: {
    byContratacao: (identContratacao: string) =>
